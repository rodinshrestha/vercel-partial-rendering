...
import SearchBreadCrumbs from "@/search/components/SearchBreadCrumbs";
...
import { fetchfilteredCatalogSearchFilter } from "@/search/services/search-service";
...
const SearchPage = ({ searchParams, filterdData, filterAttributes }: Props) => {
  ...
  React.useEffect(() => {
    ...
    fetchfilteredCatalogSearchFilter(
      clientHeaders,
